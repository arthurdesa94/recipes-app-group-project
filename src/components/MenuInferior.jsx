...
function MenuInferior({ type }) {
  ...
  return (
    ...
    >
      <Link className={ `link  text-trueGray-800 rounded-full transform hover:scale-110 hover:text-lightBlue-400 transition-all ${type === 'drinks' ? 'text-lightBlue-400' : textGray} ` } to="/bebidas">
